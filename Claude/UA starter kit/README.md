# Cowork UA Starter Kit Setup Guide

This guide walks you through the process of downloading and configuring the AppsFlyer Cowork UA Starter Kit in Claude Desktop.

## Overview

The Cowork UA Starter Kit gives User Acquisition managers a ready-to-use Cowork project for working with AppsFlyer data through MCP. Drop it into Cowork as an existing folder, say *Let's go*, and Claude handles the rest.
...
- The starter kit [zip file](https://raw.githubusercontent.com/AppsFlyerKnowledge/appsflyer-ai-agents-examples/refs/heads/main/Claude/UA%20starter%20kit/cowork-ua-starter-kit.zip)

## Setup

### Step 1: Download and Unzip the Starter Kit

1. Download the [starter kit zip](https://raw.githubusercontent.com/AppsFlyerKnowledge/appsflyer-ai-agents-examples/refs/heads/main/Claude/UA%20starter%20kit/cowork-ua-starter-kit.zip).

2. Unzip it somewhere on your machine you'll remember — for example, `~/work/cowork-ua-starter-kit`.
...
1. Click **Choose folder** and select the `cowork-ua-starter-kit` folder you unzipped in Step 1.
2. Leave the **Name** as `cowork-ua-starter-kit` (or rename it to whatever you prefer).
3. Click **Create**.
